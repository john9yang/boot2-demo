...
//    private static final Logger logger = LoggerFactory.getLogger(RedisChannelListenerConf.class);
//
//
//    @Bean
...
//    private static final Logger logger = LoggerFactory.getLogger(MyRedisChannelListener.class);
//
...
//            logger.info("get "+content+" from "+p);
